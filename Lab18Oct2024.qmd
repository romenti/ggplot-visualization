...
Measuring **violence** in a country is a challenging task. \vspace{20pt}

-   **Violence** is a multifaceted concept \vspace{20pt}
-   It depends on many different factors \vspace{20pt}
-   Multiple sources are needed to capture its complexities

# Research Question

-   The level of violence may affect the mortality of a country \vspace{20pt}
-   Today, we will rely on two major data sources to explore the relationship between violence and mortality: \vspace{20pt}
    -   Data on Violece from the Institute for Economics & Peace \vspace{20pt}
    -   Data on Mortality from the United Nations \vspace{20pt}
-   We will produce multiple descriptive plots with functions from **ggplot**

# What about ggplot?

**ggplot2** is an R package for producing statistical, or data, graphics \vspace{10pt}

It is already available in *tidyverse*!

::: {layout-ncol="2"}
![](Images/ggplot_book.png){width="1.5in"}

![](Images/logo-ggplot2.png){width="1.5in"}
:::

# ggplot

Major advantages: \vspace{20pt}

-   creating graphs by combining independent components \vspace{20pt}
-   detailed theming system to generate nice-looking graphs \vspace{20pt}
-   intuitive grammar \vspace{20pt}
-   graphs are R objects

# Indicators for violence and mortality

-   **Violence** $\rightarrow$ **Global Peaceful Index** (GPI) that measures the violence of a country across three dimensions: \vspace{20pt}
    -   ongoing domestic and international conflict \vspace{10pt}
    -   societal safety and security \vspace{10pt}
    -   militarization \vspace{20pt}
-   **Mortality** $\rightarrow$ **life expectancy at birth** ($e_0$) \vspace{10pt}
    -   common indicator for capturing the mortality of a population

# Data files

Two *.txt* data files on Virtuale \vspace{20pt}

-   *gpi_data.txt* $\rightarrow$ GPI for multiple countries over 2008-2022 \vspace{20pt}
-   *life_exp_data.txt* $\rightarrow$ life expectancy estimates for multiple countries over 2008-2022 couple \vspace{10pt}
    -   Regional classification included \vspace{10pt}
    -   Total population size

# Upload data in Rstudio

Upload *tidyverse* and the data sets \vspace{10pt}
...
Combine the two data sets by *iso3* (unique to each country) and *Year* \vspace{10pt}
...
We match all records in *gpi_data*, whose *iso3* and *Year* values have a correspondence in *life_exp_data* \vspace{10pt}
...
Calculate region- and year-specific levels of violence \vspace{10pt}
...
Create a similar visual aid for life expectancy \vspace{10pt}

Calculate region-specific life expectancy estimates \vspace{10pt}
...
Produce two scatter plots to display the relationship between violence and life expectancy in 2008 and 2022. Add also a regression line. \vspace{20pt}

::: notes
. . .
:::

Select records for years 2008 and 2022 \vspace{10pt}
...
Let's create the data sets \vspace{10pt} Most violent countries
...
Produce a scatter plot to display the relationship between violence and life expectancy in 2008 and 2022. \vspace{5pt} Make sure to set different shapes and colors for the points according to the region where they are located. \vspace{5pt} Fix the size of the points according to the population size of the country
...
Display the variation in the level of violence between 2008 and 2022 for the top 5 countries experiencing the largest increase and the top 5 showing the largest decrease in violence in Europe, Central Asia & North America \vspace{10pt}
...
*ggsave()* allows to save plots as images in different formats (e.g. .png, .pdf, .jpeg)\vspace{20pt}
...
Note that graphs can also be saved by pressing the Export bottom in the *Plots* section
...
For other exciting visualizations see the online book https://ggplot2-book.org

\vspace{20pt}

![](images/cheatsheet-01.png){width="8cm" height="5cm"}
